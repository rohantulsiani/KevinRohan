  ...
  render() {
  	return (
		<div className="col-sm-12 container">
    		<h2 style={{marginTop:'15px', textAlign: "center"}} className="col-sm-12" id="loginPage">Login</h2>
    		...
    		<div className="form-group col-sm-12">
	    		<div className="col-sm-12" ref = "loginForm">
					...
					<input id = "email"  name="emailInputBox" onChange={(event)=>{this.setState({email: event.target.value})}} style={{display:"block", margin: "auto", marginBottom:"15px", color: "black"}} type="text" className="col-sm-5 form-control" placeholder="Email" />
					<label style={{textAlign:'center'}} className="col-sm-12" htmlFor="password" id="passwordForm">Password</label>
					<input id = "password" name="passwordInputBox" onChange={(event)=>{this.setState({password: event.target.value})}} style={{display:"block", margin: "auto", color: "black"}} type="password" className="col-sm-5 form-control" placeholder="Password" />
					
					<div className="col-sm-12">
						<button id="registerButton" onClick={()=>{this.createUser(this.state.email.trim(), this.state.password.trim())}} style={{display:"block", margin:"auto", marginTop: "15px"}} className="col-sm-2 btn btn-success">Register</button>

...
export default class CreateEntityModal extends Component {
  ...
  submitToFirebase() {
    ...
    addEntity(this.props.user, uid, entityType, options, owner, subject, timeLimit, anonymous, category, details, tags, timeCreatedAt)
  }
  ...
  render() {
    ...
    // }
      ...
      <div className="col-sm-4">
        <button disabled={!this.props.isLoggedIn} data-toggle="modal" data-target="#createModal" style={{backgroundColor: "#db3236"}} className="col-sm-12 btn btn-success" id="addEntityButton">Add Entity</button>
